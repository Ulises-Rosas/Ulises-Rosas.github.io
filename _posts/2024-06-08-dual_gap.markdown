...
Now we are ready to substitute the value of $\mathbf{z}$ and the condition for $T_{2,j}$ into our initial Lagrangian function. Let us start with $T_1$, and apply some linear algebra:
...
# Implemented dual gap: 9.04182059547759e-05
```
