...
$$
\begin{equation}
\mathbf{P}(t) = e^{ \textbf{Q}t } =  \frac{1}{0!}(\textbf{Q}t)^0 + \frac{1}{1!}(\textbf{Q}t)^1 + \frac{1}{2!}(\textbf{Q}t)^2 + \cdots\\
\mathbf{P}(t) =  \textbf{I} + \textbf{Q}t + \frac{1}{2!}(\textbf{Q}t)^2 + \cdots\\
\end{equation}
$$
...
\begin{bmatrix} |                     &        & |                    \\
                \mathbf{P}^{\prime}_1 & \cdots & \mathbf{P}^{\prime}_n\\
                |                     &        & |                    \end{bmatrix}  = 
\begin{bmatrix} \textbf{q}_1\mathbf{P}_1 & \cdots & \textbf{q}_1\mathbf{P}_n \\
                \vdots                   & \ddots & \vdots                    \\
                \textbf{q}_n\mathbf{P}_1 & \cdots & \textbf{q}_n\mathbf{P}_n  \end{bmatrix} 
$$
...
\begin{bmatrix} |                     \\
                \mathbf{P}^{\prime}_1 \\
                |                     \end{bmatrix}  = 
\begin{bmatrix} \textbf{q}_1\mathbf{P}_1 \\
                \vdots                   \\
                \textbf{q}_n\mathbf{P}_1  \end{bmatrix} = 
...
\begin{bmatrix} |            \\
                \mathbf{P}_1 \\
                |  \end{bmatrix}  = \textbf{Q}\mathbf{P}_1
$$

$\mathbf{P}^{\prime}_1$ column vector can be directly solved:

$$
\mathbf{P}^{\prime}_1 = \textbf{Q}\mathbf{P}_1 \Rightarrow  \mathbf{P}_1(t) =  e^{ \textbf{Q}t } \mathbf{P}_1(0)
$$
...
$$
\begin{bmatrix} |               &        & |              \\
                \mathbf{P}_1(t) & \cdots & \mathbf{P}_n(t)\\
                |               &        & |              \end{bmatrix}  = 
\begin{bmatrix} |                                 &        & |                                \\
                e^{ \textbf{Q}t } \mathbf{P}_1(0) & \cdots & e^{ \textbf{Q}t } \mathbf{P}_n(0)\\
                |                                 &        & |                                 \end{bmatrix}\\
...
e^{ \textbf{Q}t }\begin{bmatrix} |               &        & |              \\
                                 \mathbf{P}_1(0) & \cdots & \mathbf{P}_n(0)\\
                                 |               &        & |               \end{bmatrix}\\

\Rightarrow \mathbf{P}(t) = e^{ \textbf{Q}t }\mathbf{P}(0)
$$
...
Under the K2P model with $$k = 2$$, if we let a branch length be $$0.2$$, the probability transition matrix with $$t = 2$$ can be represented as:
